...
import { RescheduleEvent } from "@/calendar/reschedule";
import { ApproveEvent } from "@/calendar/approve";
import { CancelEvent } from "@/calendar/cancel";
            ...
            <div>
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/">
                      {event?.facility?.building?.location ?? ""}
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/components">
                      {event?.facility?.building?.name ?? ""}
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
          ...
          <div className="flex flex-row justify-between">
            <div className="flex flex-col gap-2">
              <div className="mt-1 flex items-center gap-1">
                ...
                <p className="text-foreground">{event.user.email}</p>
              </div>
